...
export const TIPS: readonly Tip[] = [
  ...
  { text: 'Shift+Tab cycles build → read-only (SAFE) → plan → god modes', category: 'shortcut' },
  ...
  { text: '/godmode switches to god mode (maximum autonomy, all gates off)', category: 'command' },
  { text: '/safemode switches to SAFE mode (alias for read-only: no writes, no exec)', category: 'command' },
