...
vi.mock('../src/tui/lib/capabilities.js', () => ({
  detectCapabilities: vi.fn(() => ({ trueColor: true, colors256: false, colors16: false })),
}));

import { resolveColor, __testing, resetCapabilitiesCache } from '../src/tui/theme/tokens.js';
import { detectCapabilities } from '../src/tui/lib/capabilities.js';
