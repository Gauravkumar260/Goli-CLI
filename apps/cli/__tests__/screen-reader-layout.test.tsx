...
} from '../src/tui/hooks/useIsScreenReaderEnabled.js';
import { ScreenReaderAppLayout } from '../src/tui/components/ScreenReaderAppLayout.js';
import {
  detectCapabilities,
