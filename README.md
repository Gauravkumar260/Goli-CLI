...
[![Tests: 3376](https://img.shields.io/badge/tests-3376-brightgreen)](docs/coverage-report.md)
...
much as a tool — every loop of the repo has pushed the OpenAI/Anthropic
things I don't have access to, the TUI, the tool sandbox, the
...
npm test             # vitest unit + integration (documented ~3,376 tests)
