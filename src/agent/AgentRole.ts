...
export type AgentRole = 'orchestrator' | 'planner' | 'implementer' | 'scout' | 'compaction'
...
You do NOT write code. You plan, delegate, and synthesize.`,
    allowedTools: ['search_code', 'read_file', 'list_directory', 'git_status', 'git_diff'],
    maxTurns:     10,
...
Output a structured summary of your findings.`,
  ...
  compaction: {
    role:         'compaction',
    systemSuffix: 'Summarize the agent session history. Be precise. 300 words max.',
    allowedTools: [],
    maxTurns:     1,
    modelSpec:    'gemini/gemini-2.0-flash-lite',
  },
