 ...
 * PR description.
 *
 * ## Classification of existing goli-cli tools (22 tools)
 *
 * All 22 existing core tools are at **rung 6 (core)** by definition. They
 ...
 *
 * All 22 core tools are currently at rung 6 (core_tool). The `recommended`
...
/** The classification table for all 22 existing core tools. */
