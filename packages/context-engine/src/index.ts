...
export function createContextEngine(opts: {
  ...
  return { indexer, symbolGraph, retriever, compaction, indexWorkspace };
}
 ...
 *
 */
export { ProjectMapGenerator } from './project-map.js';
/**
 *
 */
export type { ProjectMapGeneratorOptions } from './project-map.js';
